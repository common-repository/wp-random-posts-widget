<?php
/*
Plugin Name: WP random posts widget
Plugin URI: http://ns99.info/wp-plugins/wp-random-posts-widget.html
Description: Display Random Posts Widget.
Author: Furlan365
Version: 1.2.2
Author URI: http://ns99.info/
*/
/*  Copyright 2011  Furlan365  (email : furlan365@gmail.com)
...
function ara_get_random_posts($numPosts = '5',$category = '') {
	...
	$lPosts = (array) array_rand($the_ids,($numPosts > count($the_ids) ? count($the_ids) : $numPosts));
